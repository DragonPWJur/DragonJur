...
abstract class BaseTest {
    ...
    void launchBrowser(ITestContext testContext) {
        LoginUtils.loginAndCollectCookies(LoginUtils.COOKIES_FILE_PATH, ProjectProperties.USERNAME, ProjectProperties.PASSWORD);
    ...
    void createContextAndPage(Method method) {
        ...
        context = BrowserManager.createContextWithCookies(browser, LoginUtils.COOKIES_FILE_PATH);
