...
public class GmailUtils {
    ...
    private static final String COMMON_EMAIL_PART = ProjectProperties.USERNAME.substring(0, 15);
    private static final String EMAIL_END_PART = ProjectProperties.USERNAME.substring(16);
